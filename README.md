...
A relational database is a kind of database software which keeps data organized into given tables (Postgres, Sqlite, etc.).  SQL is a language used to access and control relational databases.

- [X] Why do tables need a `primary key`?
A primary key allows tables to not be clustered, and to be joinable, and to not have duplicate records.

- [X] What is the name given to a table column that references the primary key on another table.
What is the name given to a table column that references the primary key on another table.

- [X] What do we need in order to have a _many to many_ relationship between two tables.
Multiple tables and linked records fields.
